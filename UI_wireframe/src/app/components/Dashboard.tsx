...
const recentDocs = [
  {
    id: 1,
    name: "NDA_Merriweather_Corp_v3.pdf",
    type: "NDA",
    confidence: 97,
    status: "complete",
    time: "2 min ago",
  ...
  {
    id: 2,
    name: "ServiceAgreement_TechVentures_2026.pdf",
    type: "Contract",
    confidence: 91,
    status: "complete",
    time: "14 min ago",
  ...
  {
    id: 3,
    name: "IP_Assignment_Founders.docx",
    type: "IP",
    confidence: 84,
    status: "review",
    time: "1 hr ago",
  ...
  {
    id: 4,
    name: "Employment_Agreement_Q2_Batch.pdf",
    type: "Employment",
    confidence: 96,
    status: "complete",
    time: "2 hr ago",
  ...
  {
    id: 5,
    name: "LicenseAgreement_OpenSourceLib.pdf",
    type: "License",
    confidence: 72,
    status: "review",
    time: "3 hr ago",
    ...
    <div className="flex flex-col gap-6 p-6 overflow-y-auto h-full">
      ...
      >
        <div>
          ...
          <p className="text-sm mt-0.5" style={{ color: "#94A3B8" }}>
            Wednesday, June 17, 2026 — 7 documents queued
          </p>
        </div>
        <button
      ...
      <div className="grid gap-4" style={{ gridTemplateColumns: "1fr 340px" }}>
        ...
        >
          ...
          {[
            { label: "Claude Opus 4.8", status: "active", latency: "1.2s" },
            { label: "GPT-4o", status: "standby", latency: "0.9s" },
            { label: "OCR Engine v3", status: "active", latency: "0.4s" },
          ].map((m) => (
              ...
              <div className="flex items-center gap-2">
                <div
                  ...
                  style={{
                    width: 7,
                    height: 7,
                    background: m.status === "active" ? "#10B981" : "#475569",
                    boxShadow: m.status === "active" ? "0 0 6px #10B981" : "none",
                  }}
                />
                <span className="text-xs" style={{ color: m.status === "active" ? "#F1F5F9" : "#64748B" }}>
                  {m.label}
                </span>
              </div>
          ...
          <tbody>
            {recentDocs.map((doc, i) => (
              <tr
                ...
                style={{ borderBottom: i < recentDocs.length - 1 ? "1px solid rgba(255,255,255,0.04)" : "none" }}
